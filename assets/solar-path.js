(function(){
  ...
  const year=Number(hawaiiParts.year),month=Number(hawaiiParts.month),day=Number(hawaiiParts.day);
  ...
  const sunriseUtc=solarHour(true),sunsetUtc=solarHour(false);
